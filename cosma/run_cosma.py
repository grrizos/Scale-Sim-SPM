...
if __name__ == '__main__':
    ...
    parser.add_argument('--time-limit', type=float, default=None,
                         help='CBC solve time limit, seconds. Default: unbounded -- '
                              'run until CBC proves Optimal or Infeasible, however '
                              'long that takes (a large model like DenseNet-121 near '
                              'its spill/retrieve boundary can genuinely need more '
                              'time than any fixed default would guess correctly).')
